...
const translations = {
  en: {
    ...
    'reviews.subtitle': 'Read authentic reviews from traders about {{firmName}}',
    'reviews.seoTitle': 'Trader Reviews & Ratings',
    'reviews.seoDescription': 'Read verified trader reviews and ratings for {{firmName}}. Get insights from real users about their trading experience.',
    'reviews.businessReply': 'Business Reply',
    ...
    'reviews.filterByStars': 'Filter by stars',
    ...
    'reviews.noReviewsDescription': 'Be the first to share your experience with this prop firm.',
